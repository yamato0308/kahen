...
　可変抵抗回路用プログラムです。
　timeモードとpcモードがあります。トグルスイッチで切り替えて使用してください。緑の大きいスイッチはリセットボタンです。
　timeモードの時の時間の設定は25行目の数値を変更して行ってください。
　pcモードの時はシリアルモニタのメッセージの欄にゲート電圧を入力してください。(ctrl + shift + mでシリアルモニタが開きます) 
　0 ~ 5.0Vの範囲で入力できます。少数第一位まで入力できます。
　使用したトランジスタのデータシート：https://akizukidenshi.com/goodsaffix/BSS138.pdf
　
======================================================================================================================================================
*/
#include <Wire.h>
...
unsigned long totalTime = 30000;      // <===================================================================== timeモードの時、この数値を変えて合計時間（ミリ秒）を設定(初期値30秒) 
